<template>
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <form class="chat-form rounded-pill bg-dark"
              ...
              action="/api/messages" style="width: 90%; margin-left: 60px;">
            <input type="hidden" name="_token" :value="$root.csrf_token">
            <input type="hidden" name="conversation_id" :value="conversation.id">
            <div class="row align-items-center gx-0">
                <div class="col-auto" @click.prevent="selectFile()">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea name="message" v-model="message" @focus="$root.markAsRead()" @keyup="startTyping()" class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true"></textarea>
        ...
        sendMessage(){
            ...
            fetch('/api/messages', {
                ...
                .then(json => {
                    ...
                    // empty message input after send
                    this.message = "";
                ...
                console.log(error);
                    // console.log(this.$root.csrfToken);
                    alert(error);
                    // empty message input after send
                    this.message = '';
        ...
        startTyping() {
            if (!this.start_typing) {
                ...
                this.$root.chatChannel.whisper('typing', {
                    id: this.$root.userId,
                    conversation_id: this.conversation.id // to avoid show is typing in all conversations only what user in
                });
            }
            if (this.timeout) {
                clearTimeout(this.timeout);
            }
            // could run after time to start typing
