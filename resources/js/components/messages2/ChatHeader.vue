                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col-auto">
                                <div class="avatar avatar-online d-none d-xl-inline-block">
                                    <img class="avatar-img" v-bind:src="conversation?.participants?.[0]?.avatar_url" alt="">
                                </div>
                            </div>

                            <div class="col overflow-hidden">
                                <h5 class="text-truncate" id="chat-name">{{ conversation?.participants?.[0]?.name || 'Unknown' }}</h5>
                            ...
                            <div class="col-auto">
                                <div class="avatar-group">
                                    <a href="#" class="avatar avatar-sm" data-bs-toggle="modal" data-bs-target="#modal-user-profile">
                                        <img class="avatar-img assets/img/avatars/2.jpg" src="" alt="#">
                                    </a>

                                    <a href="#" class="avatar avatar-sm" data-bs-toggle="modal" data-bs-target="#modal-profile">
                                        <img class="avatar-img assets/img/avatars/1.jpg" src="" alt="#">
                                    </a>
                                </div>
                            </div>
                        </div>
