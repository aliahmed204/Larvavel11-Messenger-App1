<template>
    <div class="chat-body hide-scrollbar flex-1 h-100">
        <div class="chat-body-inner">
            <div class="py-6 py-lg-15" id="chat-body">
                    ...
                    <div class="message-inner">
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery" v-if="message.type!='text' && message.body.mimetype.match(/image\/.+/)">
                                    <div class="row gx-3">
                                        <div class="col">
                                ...
                                <div class="message-text" v-if="message.type!='text'">
                                    <div class="row align-items-center gx-4">
                                        <div class="col-auto">
                                            <a v-bind:href="'/storage/' + message.body.file_path" class="avatar avatar-sm" :download="message.body.file_path.split('/').pop()">
                        ...
                        <div class="message-footer">
                            <span class="extra-small text-muted">{{ moment(message.created_at) }}</span>
                        </div>
                    </div>
                </div>
            </div>
