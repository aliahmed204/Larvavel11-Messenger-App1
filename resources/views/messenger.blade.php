                                            ...
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row align-items-center gx-5">
                                                        <div class="col-auto">
                                                            <a href="#" class="avatar ">
                                                                <img class="avatar-img" src="{{ $friend->avatar_url }}" alt="friend avatar">
                                                            </a>
                                                        </div>
...
{{--                                <chat-list />--}}
                                ...
                                <div class="container py-8">
                                        ...
                                        <div class="card-list" id="chat-list">
                                            {{--<a href="{{route('home', $conversation->id)}}" class="card border-0 text-reset">
                                                <div class="card-body">
                                                    <div class="row gx-5">
                                                        <div class="col-auto">
                                                            <div class=avatar-online'>
                                                                --}}{{--                                                                <img src="#" alt="" class="avatar-img">--}}{{--
                                                                <span class="avatar-text">{{ strtoupper(substr($conversation->participants[0]->name, 0, 1)) }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="col">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <h5 class="me-auto mb-0">{{ strtoupper($conversation->participants[0]->name) }}</h5>
                                                                <span class="text-muted extra-small ms-2">{{ $conversation->lastMessage->created_at->diffForHumans()  }}</span>
                                                            </div>

                                                            <div class="d-flex align-items-center">
                                                                <div class="line-clamp me-auto">
                                                                    {{ Str::words($conversation->lastMessage->body, 20) }}
                                                                </div>
            ...
            <main class="main is-visible" data-dropzone-area="">
                <div class="container h-100">
                        ...
                        <div class="d-flex flex-column h-100 justify-content-center text-center chat-div" >
                            <!-- Chat: Header -->
                                            ...
                                            <div class="col-12 col-xl-6">
                                                <div class="row align-items-center gx-5">
                                                    ...
                                                    <div class="col overflow-hidden">
                                                        <h5 class="text-truncate" id="chat-name">{{--{{ $chat?->participants[0]->name }}--}}</h5>
